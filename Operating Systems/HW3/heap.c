...
/*
    ...
    Custom comparator for heap that compares nodes based parameter (file size) as per the policy SFF 
    Returns 1 iff value at index i has larger size than at index j
*/
int heap_comparator(heap* Heap, int i, int j){
